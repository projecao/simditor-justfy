class AlignmentsButton extends Simditor.Button
  ...
  setActive: (active, align = 'left') ->
    align = 'left' unless align in ['left', 'center', 'right', 'justify']
    if align == 'left'
      super false
    else
      super active

    @el.removeClass 'align-left align-center align-right align-justify'
  ...
  command: (align) ->
    unless align in ['left', 'center', 'right', 'justify']
